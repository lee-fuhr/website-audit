        ...
        <section className="section border-t-2 border-[var(--border)] print:hidden">
          <div className="container">
            <div className="max-w-xl ml-auto">
              ...
              >
                <p className="text-xs uppercase tracking-wider text-white/70 mb-2">Start the deep dive →</p>
                <h3 className="text-lg font-semibold text-white mb-1">Your message</h3>
                <p className="text-sm text-white/80">How clearly you communicate what you do and why it matters</p>
              </button>
            </div>
          </div>
        </section>
            ...
            <div className="container">
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  ...
                  <p className="opacity-90 mb-4">
                    This audit uses my proprietary messaging evaluation methodology, refined across
                  ...
                  <p className="opacity-90">
                    The goal is simple: help you stop sounding like everyone else so buyers choose
                    you for reasons other than price.
                  </p>
                </div>
                <div>
                  <h3 className="text-xl font-semibold mb-4">Questions?</h3>
                  <p className="opacity-90 mb-4">
                    This isn't a sales pitch. If something in this audit is unclear or you want to
                    discuss a specific recommendation, I'm happy to chat.
                  </p>
                  <p className="opacity-90">
              ...
              <div className="border-t border-white/20 mt-8 pt-8 text-sm relative">
                ...
                <p className="text-center opacity-70">
                  © {currentYear} Lee Fuhr Inc · This audit was prepared exclusively for {auditData.company}
                </p>
                <span className="absolute bottom-0 right-0 text-[10px] opacity-50 font-mono">v0.4.0</span>
              </div>
            </div>
          </footer>
        ) : (
            ...
            <div className="container">
              <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm relative">
                <p className="opacity-70">
                  © {currentYear} Lee Fuhr Inc · Audit for {auditData.company}
                </p>
                <p className="opacity-70">
                  Questions? <a href="mailto:hi@leefuhr.com" className="hover:underline">hi@leefuhr.com</a>
                </p>
                <span className="absolute bottom-0 right-0 text-[10px] opacity-50 font-mono">v0.4.0</span>
              </div>
            </div>
